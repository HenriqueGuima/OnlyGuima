...
function App() {
  // const Container = lazy(() => import("@material-ui/core"));
  ...
  const AgileComponent = lazy(() => import("./components/AgileComponent"));
  const WeMakeItComponent = lazy(() =>
    import("./components/WeMakeItComponent")
  );
  const CMComponent = lazy(() => import("./components/CMComponent"));
